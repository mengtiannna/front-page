...
export default () => {
  ...
  const { brandModal, goodsModal, formData } = state;
    ...
    <>
      <List className="h5-goods-List">
        {data.map((item, index) => {
          ...
          >
            <img className="img" src={item.goodsImg || item.goodsInfoImg} alt="" />
            <div className="goods-content">
              <div className="goodsName">{item.goodsName || item.goodsInfoName}</div>
