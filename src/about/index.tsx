...
export default function About(props) {
  ...
  return (
    <div className="about">
      ...
      <div>
        <div className="info-con info-con-reverse">
          {!isMobile && (
